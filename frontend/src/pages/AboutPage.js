...
import { Shield, Users, Code, Zap, Heart, Github } from 'lucide-react';
          ...
          <div className="bg-slate-900/40 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex items-center justify-center">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center space-x-3 bg-slate-800 hover:bg-slate-700 border border-slate-600 hover:border-slate-500 text-slate-300 hover:text-white px-8 py-4 rounded-xl transition-all duration-300 group"
              >
                <div className="flex items-center space-x-3">
                  <img 
                    src="https://avatars.githubusercontent.com/u/198504820?s=200&v=4" 
                    alt="SecToolBox Organization" 
                    className="w-8 h-8 rounded-full border border-slate-600 group-hover:border-slate-500 transition-colors"
                  />
                  <div className="flex items-center space-x-2">
                    <Github className="w-5 h-5" />
                    <span className="font-medium">Visit our GitHub organization</span>
                  </div>
                </div>
              </a>
            </div>
